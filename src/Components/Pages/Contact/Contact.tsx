  ...
  return (
    <div>
      ...
      <div className='max-w-screen font-poppins overflow-hidden'>
        <section
          className="relative z-10 overflow-hidden bg-gradient-to-br from-blue-100 py-20 sm:px-20 sm:py-20"
          >
          <div className="container mx-auto">
              <div className="flex flex-wrap -mx-4 lg:justify-between">
                <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div className="mb-12 max-w-[570px] lg:mb-0 pl-4">
                      <span className="text-blue-400 block mb-4 text-base font-semibold text-primary">
                      Contact Us
                      </span>
                      <h2
                          className="text-black text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                          >
                          GET IN TOUCH WITH US
                      </h2>
                      <p
                          className="text-base leading-relaxed text-body-color text-gary-400-6 mb-9"
                          >
                      ...
                      <div className="mb-8 flex w-full max-w-[370px]">
                          <div
                            className="bg-blue-400/30 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
                            >
                            <svg
                                width="32"
                                height="32"
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  <div className="w-full mb-10">
                    ...
                    <div>
                        <span
                          className="bg-blue-400/80 inline-block px-4 py-1 mb-5 text-xs font-semibold leading-loose text-center text-white rounded bg-primary"
                          >
                        Dec 22, 2023
                        </span>
                        <h3>
