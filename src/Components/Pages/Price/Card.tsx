...
const Card = ({ standOutBg, marginMiddle, Package, Price, image, Feature1, Feature2, Feature3, Feature4, Feature5, Feature6, iconColor1, iconColor2, iconColor3, iconColor4, iconColor5, iconColor6,buttonTextColor, buttonBg, hoverBgButton }) => {
    return (
        <div className={`w-full shadow-xl flex flex-col p-4 my-4 ${standOutBg} ${marginMiddle} rounded-lg hover:scale-105 duration-300`}>
            ...
            <p className='py-2 mx-8 mt-8 flex -mt-2 justify-center text-3xl font-bold'>{Price}</p>
