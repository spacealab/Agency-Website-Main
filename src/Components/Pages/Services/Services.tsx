            ...
            <section className="max-w-8xl mx-auto container bg-white pt-16">
              <div className=''>
                <div role="contentinfo" className="flex items-center flex-col px-4">
                  <p tabIndex={0} className="focus:outline-none uppercase text-sm text-center text-gray-600 leading-4">Start Today and</p>
                  <h1 tabIndex={0} className="text-4xl sm:text-5xl font-extrabold text-center leading-10 text-gray-800 sm:w-[70%] w-[95%] pt-4">Level Up your Business & Maximise your Company’s Income & Productivity</h1>
                </div>
                <div tabIndex={0} aria-label="group of cards" className="focus:outline-none mt-20 flex flex-wrap justify-center gap-10 px-4">
                  <div tabIndex={0} aria-label="card 1" className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12">
                      <h2 tabIndex={0} className="focus:outline-none text-lg font-bold leading-tight text-gray-800">Always have a Clear Overview:</h2>
                      <p tabIndex={0} className="focus:outline-none text-base text-gray-600 leading-normal pt-2">Always have a clear overview of what’s going on with your investments and how well everything is performing. We deliver a detailed performance report on everything important!</p>
                    </div>
                  </div>
                  <div tabIndex={0} aria-label="card 2" className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12">
                      <h2 tabIndex={0} className="focus:outline-none text-lg font-semibold leading-tight text-gray-800">Always catch a Rising-Trend:</h2>
                      <p tabIndex={0} className="focus:outline-none text-base text-gray-600 leading-normal pt-2">Never miss out on a rising trend that is hot in your industry and that is performing well in businesses and companies similar to yours. Sometimes this gets hard with the evermore-increasing workload and that’s why we use our trained professionals to help you always stay on top of your game!</p>
                    </div>
                  </div>
                  <div tabIndex={0} aria-label="card 3" className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12">
                      <h2 tabIndex={0} className="focus:outline-none text-lg font-semibold leading-tight text-gray-800">Hit your Monthly mark! Every Month!</h2>
                      <p tabIndex={0} className="focus:outline-none text-base text-gray-600 leading-normal pt-2">We know how important hitting your monthly marks is; this determines the flow of work and the overall performance of the company. This is why we use advanced algorithms and state-of-the-art technologies to help you achieve this!</p>
                    </div>
                  </div>
                  <div tabIndex={0} aria-label="card 4" className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12">
                      <h2 tabIndex={0} className="focus:outline-none text-lg font-semibold leading-tight text-gray-800">Personalized and always on Track!</h2>
                      <p tabIndex={0} className="focus:outline-none text-base text-gray-600 leading-normal pt-2">Our solutions are always personalized and tailored depending on your needs. This is why all of our clients trust us so much and 70% stay with us for as long as 5+ years.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="xl:px-20 px-6 py-20 xl:mx-auto xl:container">
            ...
            <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
                ...
                <div className="shadow-lg xl:p-6 p-4 w-48 sm:w-auto w-full bg-white sm:absolute relative z-20 sm:mt-0 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
                    ...
                    <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">Average Performance Increase
                ...
                <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
                    ...
                    <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">Companies Purchase Again
